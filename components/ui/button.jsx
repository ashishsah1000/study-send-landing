...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "buttonHover text-primary bg-gradient-to-br from-[#EE0979] to-[#FF6A00] hover:bg-gradient-to-tl hover:from-[#EE0979] hover:to-[#FF6A00] transition-all duration-300 ease-in-out rounded-md",
        destructive:
      ...
      size: {
        default: "px-4 py-2 min-w-32 h-10 lg:px-6 lg:py-2 lg:min-w-40 lg:h-11 rounded-md",
